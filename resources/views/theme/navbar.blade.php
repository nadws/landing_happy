...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light py-3 py-lg-0" style="background-color: {{$warna}}">
        <a href="{{ route('home') }}" class="navbar-brand">
            <h1 class="m-0 text-uppercase" style="color:{{$fontc1}};">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="#" class="nav-item nav-link" style="color: {{$fontc1}};">Beranda</a>
                <a href="#load-about" class="nav-item nav-link" style="color: {{$fontc1}};">Tentang Kami</a>
                {{-- <a href="#load-service" class="nav-item nav-link">Service</a> --}}
                {{-- <a href="#load-appointment" class="nav-item nav-link">Appointment</a> --}}
            </div>
            <a href="http://127.0.0.1:1111/login" class="btn btn-rounded btn-primary" style="margin-left: 10px">Login Front Office</a>
        </div>
    </nav>
</div>
</div>
